...
class ItemSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $cat = fn (string $code) => Category::where('code', $code)->first()?->id;
